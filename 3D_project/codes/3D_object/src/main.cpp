...
void initScene(GLFWwindow* window)
{
    ...
    programTexture.addUniform("uMtxNormal");
    ...
    programColor.addUniform("uMtxNormal");
   
    imguiWindow.setPos(&vecMove);
    imguiWindow.setAngle(&angles);
    imguiWindow.tiklaSekilOlustur= sekilOlustur;

    coni = meshManager.createConi();

    coni->setTextureShader(&programTexture);
    coni->setColorShader(&programColor);
    ...
    coni->setTexture(textureId);
    imguiWindow.setRoot(coni);
...
void draw()
{
    ...
    coni->setAngles(angles);
    coni->setPosition(vecMove);
